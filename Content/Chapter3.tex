...
\begin{enumerate}
	...
	\item H συνάρτηση \myTTT{line\_3\_check}: Ελέγχει αν υπάρχει διαμάντι στον γράφημα.    
	
	\item H συνάρτηση \myTTT{line\_5\_check}:  Ελέγχει αν υπάρχει ελάχιστο σταθερό διαχωριστής στο γράφημα.
